...
function Sidebar({ user, onLogout, threadList, onSelectThread, onNewChat, activeThreadId, isFree, isOpen, closeSidebar, setShowLoginModal }) {
  ...
  const handlePayment = async () => {
    ...
    try {
      const { data: order } = await axios.post("https://xgpt-backend-scyp.onrender.com/api/create-order");
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            const verifyRes = await axios.post("https://xgpt-backend-scyp.onrender.com/api/verify-payment", {
